...
TOOL_STATUS_MESSAGES = {
    "pesquisar_na_internet": "Buscando informações em tempo real na web...",
    "pesquisar_e_transcrever_youtube": "Pesquisando e transcrevendo tutorial no YouTube...",
    "investigar_pessoa_osint": "Realizando investigação OSINT completa e sintetizando dossiê...",
    ...
    "enviar_alerta_mudanca_slack": "Enviando alerta de alteração para o Slack...",
    "enviar_foto_slack": "Capturando e enviando foto para o Slack...",
    "ler_mensagens_slack": "Consultando mensagens recentes no Slack...",
    "listar_canais_slack": "Consultando lista de canais do Slack...",
    ...
    "controlar_luzes": "Enviando comando para os dispositivos...",
    "relatorio_status_casa": "Verificando status dos dispositivos da casa...",
    "consultar_perfil_usuario": "Consultando dados do seu perfil...",
...
TOOL_SPOKEN_STATUS_MESSAGES = {
    "pesquisar_na_internet": "Ó, vai demorar um pouquinho porque estou consultando na internet...",
    "pesquisar_e_transcrever_youtube": "Localizando e transcrevendo o tutorial no YouTube, só um momento...",
    "investigar_pessoa_osint": "Iniciando investigação OSINT detalhada, isso pode levar alguns segundos...",
    "buscar_usuario_redes_sociais_sherlock": "Rastreando perfis nas redes sociais com o Sherlock...",
    "verificar_email_osint_holehe": "Verificando contas vinculadas ao e-mail...",
    ...
    "buscar_compromissos": "Buscando compromissos na agenda...",
    "cancelar_compromisso": "Cancelando compromisso na agenda...",
    "ler_emails_recentes": "Lendo seus e-mails recentes no Gmail...",
    "buscar_emails": "Buscando e-mails na sua caixa de entrada...",
    "enviar_email": "Enviando seu e-mail...",
    "responder_email": "Respondendo o e-mail...",
    "apagar_email": "Movendo e-mail para a lixeira...",
    "criar_tarefa": "Criando a tarefa para você...",
    "listar_tarefas": "Consultando suas tarefas pendentes...",
    "concluir_tarefa": "Concluindo sua tarefa...",
    "excluir_tarefa": "Removendo a tarefa...",
    "buscar_tarefas": "Buscando tarefas...",
    "criar_nota": "Criando nota no Keep...",
    "adicionar_itens_lista": "Adicionando itens à sua lista...",
    "marcar_item_lista": "Atualizando sua lista...",
    "ler_nota": "Lendo suas anotações...",
    "listar_notas": "Consultando suas notas e listas...",
    "excluir_nota": "Removendo nota...",
    "buscar_notas": "Pesquisando suas anotações...",
    "buscar_contato": "Buscando contato na agenda...",
    "salvar_contato": "Salvando contato...",
    "listar_contatos": "Consultando seus contatos...",
    "excluir_contato": "Removendo contato...",
    "ver_camera": "Acessando as imagens da câmera...",
    "detectar_e_cumprimentar_pessoas": "Identificando pessoas na câmera...",
    "identificar_morador_ou_visitante": "Verificando se é morador ou visitante...",
    "status_camera": "Verificando as câmeras...",
    "enviar_mensagem_telegram": "Enviando mensagem no Telegram...",
    "enviar_foto_telegram": "Capturando e enviando foto no Telegram...",
    "enviar_mensagem_slack": "Enviando mensagem para o Slack...",
    "enviar_relatorio_slack": "Publicando relatório no Slack...",
    "enviar_alerta_mudanca_slack": "Enviando alerta para o Slack...",
    "enviar_foto_slack": "Enviando foto para o Slack...",
    "ler_mensagens_slack": "Consultando mensagens do Slack...",
    "listar_canais_slack": "Consultando canais do Slack...",
    "listar_automacoes": "Consultando regras de automação...",
    "controlar_automacao": "Atualizando automação...",
    "criar_automacao": "Criando automação...",
    "excluir_automacao": "Removendo automação...",
    "executar_automacao_agora": "Executando automação...",
    "consultar_manual_sistema": "Consultando o manual...",
    "controlar_luzes": "Enviando comando para os dispositivos...",
    "relatorio_status_casa": "Verificando status da casa...",
    "consultar_perfil_usuario": "Consultando dados do seu perfil...",
    "tocar_musica": "Buscando a música para você...",
    "parar_musica": "Parando a música...",
    "status_musica": "Verificando a reprodução...",
    "controlar_volume_sistema": "Ajustando o volume...",
    "controlar_brilho_tela": "Ajustando o brilho...",
    "abrir_navegador_sistema": "Abrindo o navegador...",
    "fechar_navegador_sistema": "Fechando navegador...",
    "gravar_memoria_longo_prazo": "Gravando na memória...",
    "consultar_memorias_longo_prazo": "Consultando memórias...",
    "listar_todas_memorias": "Buscando memórias...",
    "esquecer_memoria": "Removendo memória...",
...
def get_tool_friendly_status(tool_name: str) -> str:
    """Retorna uma mensagem visual amigável em português sobre a ferramenta que o agente está executando."""
    return TOOL_STATUS_MESSAGES.get(tool_name, "Processando solicitação com ferramentas...")

def get_tool_spoken_status(tool_name: str) -> str:
    """Retorna uma mensagem falada curta e natural para sintetizar em áudio enquanto a ferramenta executa."""
    return TOOL_SPOKEN_STATUS_MESSAGES.get(tool_name, TOOL_STATUS_MESSAGES.get(tool_name, "Só um momento, processando..."))
                ...
                if hasattr(ai_msg, "tool_calls") and ai_msg.tool_calls:
                    for tool_call in ai_msg.tool_calls:
                        ...
                        if callable(status_cb):
                            try:
                                friendly_text = get_tool_friendly_status(tool_name)
                                spoken_text = get_tool_spoken_status(tool_name)
                                status_cb("status", friendly_text, {
                                    "tool": tool_name,
                                    "spoken": True,
